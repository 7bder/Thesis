...
This research sets the primary purpose of explaining rail transit ridership in TOD area, from which is expanded to 4 specific aspects: 1. exploring the characteristics of variation in transit ridership and land use; 2. explaining transit ridership at station level; 3. explaining transit ridership at station-to-station level; 4. explaining the walking duration of to transit stations. To this end, the research questions are as follow: 1. to explore the overall relationship between transit ridership and land use; 2. to find an approach for screening effective influencing factors; 3. to describe the relationship of transit ridership between stations and stations; 4. to explore the relation between walking distance and walking preference.
