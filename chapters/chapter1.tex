...
\begin{sidewaystable}[htbp]
	...
	\begin{spacing}{1} % 这中间行间距1倍
		...
		\begin{tabular}{|p{8em}<{\centering}|c|p{5em}<{\centering}|p{5em}<{\centering}|p{5em}<{\centering}|p{5em}<{\centering}|p{5em}<{\centering}|p{5em}<{\centering}|p{5em}<{\centering}|p{5em}<{\centering}|p{5em}<{\centering}|p{5em}<{\centering}|}
			...
			\multirow{6}[3]{*}{\centering{Land use factors}} & Building area & & & & $\bullet$ & $\bullet$ & & $\bullet$ & $\bullet$ & $\bullet$  \\
			\Xcline{2-11}{0.5pt}
			& Hospital & & & & & & & & $\bullet$ &  \\
			\Xcline{2-11}{0.5pt}
			...
			\Xhline{0.5pt}
			\multirow{6}[3]{8em}{\centering{Transit-related factors}} & Accessibility of pedestrian & $\bullet$ & & & & & & $\bullet$ & &  \\
			\Xcline{2-11}{0.5pt}
			...
			\multirow{8}[4]{8em}{\centering{Demographic and socioeconomic environment factors}} & Population & & $\bullet$ & $\bullet$ & $\bullet$ & & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ \\
			\Xcline{2-11}{0.5pt}
