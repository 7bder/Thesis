...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.8\linewidth]{chp2ResearchArea}
...
%		\item[Note:]
%		The value marked with gray is adopted in this study.
%	\end{description}
%\end{table}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.8\linewidth]{chp2AICcBandwidths}
...
\begin{figure}[htbp]
	\centering
	\normalsize
	\includegraphics[width=0.7\linewidth]{chp2LocalR}
