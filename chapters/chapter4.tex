...
%
As to passengers, the acceptant walking distance/duration is not only associated with features of the built environment such as the scale of stations and the functions of the buildings around stations, but also the features of passengers' individual characteristics, such as occupations and trip purposes.
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=\linewidth]{chp4DataCleaning}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=\linewidth]{chp4RandomForests}
...
\bibliography{chapters/ref_AURG}