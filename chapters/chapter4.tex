\chapter{Influencing Factors on Ridership at Station Level}
\markright{CHAPTER 4}
%
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.8\linewidth]{chapter3/ResearchArea}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.8\linewidth]{chapter3/AICcBandwidths}
...
\begin{figure}[htbp]
	\centering
	\normalsize
	\includegraphics[width=0.7\linewidth]{chapter3/LocalR}
...
\begin{figure}[htbp]
	...
	\begin{minipage}{0.48\linewidth}
		\centering
		\includegraphics[width=\linewidth]{chapter3/TransportationFacility} % 这里的图片宽度是相对minipage的，所以1倍就可以了
		\centering{Transportation Facility}
	\end{minipage}
	\hfill % 横向填充，均匀分布
	\begin{minipage}{0.48\linewidth}
		\centering
		\includegraphics[width=\linewidth]{chapter3/BusCapacity}
	...
	\begin{minipage}{0.48\linewidth}
		\centering
		\includegraphics[width=\linewidth]{chapter3/BusAccessibility}
		\centering{Bus Accessibility}
	\end{minipage}
	\hfill
	\begin{minipage}{0.48\linewidth}
		\centering
		\includegraphics[width=\linewidth]{chapter3/PopulationJobBalance}
	...
	\begin{minipage}{0.48\linewidth}
		\centering
		\includegraphics[width=\linewidth]{chapter3/TenantProportion}
		\centering{Tenant Proportion}
	\end{minipage}
	\hfill
	\begin{minipage}[c]{0.48\linewidth}
		\centering
		\includegraphics[scale=0.3]{chapter3/Legend}\\
	\end{minipage}
