...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.8\linewidth]{chapter5/StationDistribution}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\linewidth]{chapter5/DataCleaning}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=\linewidth]{chapter5/AgeDistribution}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=\linewidth]{chapter5/DurationDistribution}
...
\begin{sidewaystable}[htbp]
	...
	\label{tab:chp5:StatisticalDescription}
	\centering
	\small
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.7\linewidth]{chapter5/RandomForests}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.7\linewidth]{chapter5/Prediction5Min} \\
	\includegraphics[width=0.7\linewidth]{chapter5/Prediction8Min} \\
	\includegraphics[width=0.7\linewidth]{chapter5/Prediction13Min} \\
